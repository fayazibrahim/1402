...
namespace task123
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("\n1. Qrup elave et");
                Console.WriteLine("2. Butunn qruplara bax");
                Console.WriteLine("3. Verilmiş point aralıgındaki qruplara bax");
                Console.WriteLine("4. Verilmis nomrəsi qrupa bax");
                Console.WriteLine("5. Verilmis qruplar uzre axtarıs et");
            ...
            case "5":
                ...
                break;
            case "0":
                Console.WriteLine("program basha catdi");
                break;
            default:
                Console.WriteLine("\nSeciminiz sehvdir!");
                break;
